...
dir <- "O:/Projects/KP0011/1/Senescence-Project/Data/Spectra/"
setwd(dir)

data <- readRDS("smth_avg_rflt_bin3_scrunscaled.rds")
...
tuneGrid <- expand.grid(committees = c(1, 5, 10, 20, 50, 100),
                        neighbors = 0)
